...
|---------|------|-----------|
| **1.12.1** | 2026-06-12 | 🛡️ Adversarial verification — independent agent checks for "should've changed but didn't" before release |
| **1.12.0** | 2026-06-12 | 🔍 Research gate — optional background research between newbie-guide and project-master |
