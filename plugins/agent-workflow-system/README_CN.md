...
**你不需要搞懂这个系统。** 直接说你想干嘛。AI 会一步步带你，说人话，不需要任何技术基础。
...
| `newbie-guide` | 引导者 | 模糊目标 → 可执行任务（苏格拉底式追问 + 可选背景调研） |
...
| 版本 | 日期 | 主要变更 |
|------|------|----------|
| **1.12.1** | 2026-06-12 | 🛡️ 对抗验证——铁律新增第6步，独立 agent 发布前语义验证遗漏 |
| **1.12.0** | 2026-06-12 | 🔍 调研闸门——新手引导新增可选背景调研，调研结果注入项目策划 |
| **1.11.1** | 2026-06-12 | 🐛 health-check.ps1 编码修复——3 个 bug 全修，健康度 100% |
| **1.11.0** | 2026-06-12 | 📄 PROJECT.md 项目总览——一屏读懂项目 |
| **1.10.3** | 2026-06-11 | 🗑️ 移除写入前层面自检 |
| **1.10.2** | 2026-06-11 | 📦 完整分发——scripts + hooks 纳入插件包 |
| **1.10.1** | 2026-06-11 | 🔧 phase-closeout 区分暂停/归档 |
| **1.9.2** | 2026-06-11 | 🔁 输出自检第4问 + 阶段切换自动审计 |
| **1.9.1** | 2026-06-11 | 📊 项目驾驶舱——health_score + active_tasks 自动更新 |
| **1.9.0** | 2026-06-11 | 🚪 新手模式——README 新手入口 + 术语过滤 + 新手频道规则 |
| **1.8.2** | 2026-06-11 | ⚡ 输出前自检 + 写入层面闸门——防止开发内容污染工作流 |
